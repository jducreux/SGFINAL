 ...
 * @author Juan
 */
public class ListarComprasxP extends javax.swing.JFrame {

    /**
     * Creates new form ListarComprasxP
     */
    public ListarComprasxP() {
        initComponents();
        Date da = new Date();
    ...
    private void jButtonImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonImprimirActionPerformed
        ...
        try{
            ...
            String  ruta="C:\\SG-SOFT\\subastaganadera\\src\\ReportesSG\\" +  "Comprasxproceso.jrxml";  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarComprasxP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarComprasxP().setVisible(true);
            }
        });
    }
